    ...
    public partial class FirstRunConfiguration
    {
            ...
            if (validated && (ProjectsSelected()))
            {
                try
                {
                    ...
                    List<TeamServer> servers = new List<TeamServer>
                                                   { 
                                                new TeamServer { Port = portNumber, ServerName = serverName, CollectionName = collectionName, Protocol = protocol, Projects = projects} 
                                            };
        ...
        private void Button_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (ValidEntries(false))
            {
                ...
                ListBoxProjects.Items.Clear();
                Cursor = Cursors.Wait;
                var projectList = TeamServer.GetProjectList(protocol, serverName, collectionName, portNumber);
